...
| **MEMORY**                                          | • DRAM Chip DDR3 SDRAM 8Gbit 256Mx16 1.35V/1.5V.<br>• 128 Mbit SPI NOR flash memory                                                                        | NA                                                              | NA                                          | NA                                                                                                  | • 32 MB SDRAM 166 MHz                          | • 2 GB LPDDR4 x 32                                                        | • 16MB XIP NOR + up to 200GB SDIO NAND via captive microSD card cage               | 4GB (4 x 512Mb x 16 bit) [non-ECC]              |
